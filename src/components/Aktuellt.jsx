export const Aktuellt = () => {
  return (
    <section className="flex flex-col w-full bg-gradient-to-t from-red-600/100 to-red-400/80 py-16 gap-10 items-center laptop:items-start text-warm-white">
      <div className="flex flex-col w-10/12 mx-auto laptop:w-8/12 gap-4 ">
        ...
        <div className="flex flex-col laptop:flex-row gap-16 laptop:gap-18">
          <div className="flex flex-col gap-6 laptop:w-1/2 laptop:flex-row">
            ...
            <div className=" flex flex-col gap-4 laptop:w-2/3">
              ...
              <a href="https://evarydberg.se/biljettbokning/" target="_blank">
