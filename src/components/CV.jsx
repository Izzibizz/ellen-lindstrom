...
export const CV = () => {
  ...
  return (
    <div className="flex flex-col gap-4 text-stone-700 py-10 laptop:py-16">
      <h3 className="text-3xl text-rose-800 self-center">CV</h3>
      <div className="flex flex-col gap-4">
      <div className="flex flex-col border border-rose-800 rounded-xl p-6 laptop:p-16 gap-4 laptop:max-w-[900px] laptop:mx-auto">
      <h4 className="text-rose-800 font-semibold">ERFARENHET I URVAL, SCEN</h4>
      <ul className="flex flex-col  gap-y-4 ">
        {cv[0].theater.map((production, index) => (
            <li key={index} className="border-b-1 border-rose-800 py-4 laptop:grid laptop:grid-cols-3 laptop:gap-4">
                <div>
        ...
        <div className="flex flex-col laptop:flex-row laptop:gap-20 laptop:w-full gap-10 border border-rose-800 rounded-xl p-6 laptop:max-w-[900px] laptop:mx-auto ">
        <ul className="flex flex-col gap-4">
        <h4 className="text-rose-800 font-semibold">UTBILDNING</h4>
        ...
        <h4 className="text-rose-800 font-semibold">TV & FILM</h4>
