...
export const Header = () => {
  ...
  return (
    <header className={`w-full fixed flex h-16 p-4 laptop:p-6 z-40 justify-between  items-center font-body `}>
      ...
      >
        <span
          className={` ${bgWhite ? "bg-peach" : "bg-stone-800"} hover:bg-peach block transition-all duration-300 ease-out 
      ...
      {isOpen && (
        <div
          ref={dropdownRef}
          className={`absolute laptop:top-4 laptop:right-12 top-0 z-40 right-0 w-full h-screen laptop:w-fit laptop:h-fit text-xl ${bgWhite ? "text-peach" : "text-stone-800"}  bg-warm-white/90  laptop:bg-none flex justify-center `}
        >
