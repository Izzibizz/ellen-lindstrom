      ...
      {showMore && (
        <div className="flex flex-col gap-12 animate-fadeIn"> 
          ...
          >
            ...
            <p className="text-justify">Sommaren 2025 står Ellen återigen på scen med Eva Rydberg. Nu är Eva tillbaka på Fredriksdalsteatern i Helsingborg med farsen Hjälten från Öresund. Ellen är även regiassistent i år.</p>
            <p className="text-justify">Och hösten 2026 ser vi Ellen i Spamalot som spelas på Nöjesteatern, Malmö. Ellen är då också koreografassistent och ersättare för rollen Lady of the Lake.</p>
            </div>
            <img
