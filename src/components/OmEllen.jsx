      ...
      {showMore && (
        <div className="flex flex-col gap-12 animate-fadeIn"> 
          ...
          >
            ...
            <p className="text-justify">Sommaren 2026 står Ellen återigen på scen med Eva Rydberg. Nu är Eva tillbaka på Fredriksdalsteatern i Helsingborg med farsen Hjälten från Öresund. Ellen är även regiassistent i år.</p>
